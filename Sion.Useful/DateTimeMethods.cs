...
namespace Sion.Useful
{
    ...
    public static class DateTimeMethods
    {
        ...
        /// </summary>
        /// <returns>The Unix milliseconds equivalent.</returns>
        public static long GetUnixMillisecondsNow() => ConvertToUnixMilliseconds(DateTime.Now);

        /// <summary>
        /// Returns the Unix seconds equivalent of the current time.
        /// </summary>
        /// <returns>The Unix seconds equivalent.</returns>
        public static long GetUnixSecondsNow() => ConvertToUnixSeconds(DateTime.Now);
        ...
        extension(DateTime date)
        {
            ...
            /// <param name="date">The DateTime provided.</param>
            /// <returns>The Unix milliseconds equivalent.</returns>
            public long ToUnixMilliseconds() => ConvertToUnixMilliseconds(date);
            ...
            /// <param name="date">The DateTime provided.</param>
            /// <returns>The Unix seconds equivalent.</returns>
            public long ToUnixSeconds() => ConvertToUnixSeconds(date);
        }
    }
}
