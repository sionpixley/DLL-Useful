...
namespace Sion.Useful.Graphs
{
        ...
        where TWeight : IEquatable<TWeight>, IComparable<TWeight>
    {
        ...
        public void Clear() => NodeSet.Clear();
        ...
        public bool RemoveEdge(WeightedNode<TValue, TWeight> node1, WeightedNode<TValue, TWeight> node2)
        {
            ...
            else
            {
                ...
                node1.Weights = [.. node1.Weights.Take(node2Index).Skip(1).TakeWhile(w => true)];
                node2.Neighbors.Remove(node1);
                node2.Weights = [.. node2.Weights.Take(node1Index).Skip(1).TakeWhile(w => true)];
                return true;
            }
        }
